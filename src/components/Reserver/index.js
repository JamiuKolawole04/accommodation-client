...
const Reserve = ({ setOpen, hotelId }) => {
  ...
  if (error) {
    return <p style={{ textAlign: "center" }}>Hotel does not exist</p>;
  }
    ...
    <div className="reserve d-flex align-items-center justify-content-center">
      <div className="reserve__container">
        ...
        {loading
          ...
          : data.list.map((item) => (
              <div
                className="reserve__item d-flex align-items-center"
                key={item._id}
              >
                <div className="reserveItem__info d-flex column">
                  ...
                  <div className="reserveItem__max">
        ...
        <button className="reserve__btn" onClick={handleClick}>
          Reserve now!
        </button>
      </div>
    </div>
